...
import { ArrowUp, Paperclip, Square, X, StopCircle, Mic, Globe, BrainCog, FileCode as FolderCode } from "lucide-react";
...
export const PromptInputBox: React.ForwardRefExoticComponent<PromptInputBoxProps & React.RefAttributes<HTMLDivElement>> = React.forwardRef((props, ref) => {
  const { onSend = () => {}, isLoading = false, placeholder = "Ask AI anything about your project...", className, autoFocus = false } = props;
              ...
              <Button
                ...
                className={cn(
                  ...
                  hasContent && !isLoading && !isRecording
                    ...
                    : "bg-[#3A3A40] text-[#9CA3AF] cursor-not-allowed"
                )}
              >
                {isLoading ? (
